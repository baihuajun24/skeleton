...
public class TagsRecord extends UpdatableRecordImpl<TagsRecord> implements Record3<Integer, Integer, String> {
	...
	private static final long serialVersionUID = -221599918;
	...
	/**
	 * Setter for <code>public.tags.recepit_id</code>.
	 */
	public void setRecepitId(Integer value) {
		setValue(1, value);
	}

	/**
	 * Getter for <code>public.tags.recepit_id</code>.
	 */
	public Integer getRecepitId() {
	 ...
	 */
	public TagsRecord(Integer id, Integer recepitId, String name) {
		super(Tags.TAGS);

		setValue(0, id);
		setValue(1, recepitId);
		setValue(2, name);
	}
}
